 ...
 * The passenger will be converted into this class if that passenger has between 100 and above flight cancellations and will
 ...
 * 
 * This class also has methods that return something depending on the need.
...
public class ExecutivePlatinum implements Tier {
    ...
    private int totalFlights;
     ...
     public ExecutivePlatinum(int miles, int cancelledFlights,int totalFlights)
    {
        this.miles = miles;
